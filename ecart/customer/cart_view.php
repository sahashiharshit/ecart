...
if ($result->num_rows > 0) {
    ...
    //                 <div class='card-body'>";
    //     echo "";            
    //     echo "Product: " . $row["pname"]. " - Price: " . $row["price"]. " - Quantity: " . $row["quantity"] . "<br>";
    //     echo "<a href='remove_cart.php?cart_item_id=" . $row["cart_item_id"] . "'>Remove</a><br><br>";
    //    echo "</div></div></div>";
    ?>
    <div class="col">
    <div class = "card">
...
<form class="form-control p-2" action='place_order.php' method='post'>
    <button class=" btn btn-outline-success" > <i class="bi bi-bag-check" style="font-size: 1.5rem; color: cornflowerblue;"></i> Check Out </button>
